 ...
 * 
 */
@WebServiceClient(name = "servicioWeb", targetNamespace = "http://service.online.mu/", wsdlLocation = "http://localhost:8080/ServicioWebV1/servicioWeb?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIOWEB_QNAME = new QName("http://service.online.mu/", "servicioWeb");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ServicioWebV1/servicioWeb?wsdl");
    ...
    public ServicioWeb getServicioWebPort() {
        return super.getPort(new QName("http://service.online.mu/", "servicioWebPort"), ServicioWeb.class);
    }
    ...
    public ServicioWeb getServicioWebPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.online.mu/", "servicioWebPort"), ServicioWeb.class, features);
    }
